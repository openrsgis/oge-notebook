...
class Coverage:
    ...
    def __init__(self, coverage_metadata: metadata.CoverageMetadata = None, coverage_image: oge_image.Image = None) -> None:
...
def get_coverage(product_Id: str,coverage_Id: str) -> Coverage:
    ...
    return Coverage(file_metadata,oge_image.Image(coverage_file = ogefiles.CoverageFile(file_path)))