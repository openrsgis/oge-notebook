...
def test_geometry_to_feature():
    ...
    # geo_F = feature_utils.to_OGeometry(fet)
...
def test_feature_to_geometry():
    ...
    geo_F = feature_utils.to_OGeometry(fet)
    ye = feature_utils.from_OGeometry(feature_crs=4326, feature_attribute=None, ogeometry=geo)

    print(geo)

if __name__=="__main__":
    # test_feature_to_geometry()
    test_geometry_to_feature()